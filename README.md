...
## How to Play
1. Enter a number within the given range.
2. Submit your guess to see if it matches the hidden number.
...
⭐ **Have fun guessing! If you enjoy the game, give it a star!** ⭐
